    ...
    <div className="min-h-screen w-full flex bg-white overflow-hidden">
      ...
      <div className="hidden lg:flex w-1/2 bg-red-50 relative items-center justify-center p-12 overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute top-10 left-10 w-64 h-64 bg-red-100 rounded-full blur-3xl opacity-60"
        />
        <motion.div
          animate={{ scale: [1, 1.5, 1], x: [0, 100, 0] }}
          transition={{ duration: 15, repeat: Infinity, ease: "easeInOut" }}
          className="absolute bottom-20 right-20 w-80 h-80 bg-orange-100 rounded-full blur-3xl opacity-60"
        />

        {/* Human/Logistic Illustrations Scene */}
        <div className="absolute inset-0 pointer-events-none">
          {/* Delivery Person / User Tie */}
          <motion.div
            animate={{ y: [0, -15, 0] }}
            transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
            className="absolute top-1/3 left-1/4 text-red-500/20"
          >
            <FaUserTie size={140} />
          </motion.div>

          {/* Satisfied User Check */}
          <motion.div
            animate={{ scale: [1, 1.1, 1] }}
            transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
            className="absolute bottom-1/3 right-1/4 text-red-400/30"
          >
            <UserCheck size={100} />
          </motion.div>
          ...
          <motion.div
            ...
            className="absolute top-1/2 right-10 text-orange-400/20"
          >
            <Users size={80} />
          </motion.div>
        </div>
        ...
        <div className="relative z-10 text-center space-y-8 max-w-lg">
          ...
          >
            Experience the new standard in logistics. <br /> Connected. Fast. Reliable.
          </motion.p>
        </div>
      </div>

      {/* Right Side - Login Form (Full Height, 50% width) */}
